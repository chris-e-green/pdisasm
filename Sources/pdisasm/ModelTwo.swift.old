...
class ModelTwo {
    ...
    var opTable: [UInt8: OpInfo] = [
        ...
        0x85: OpInfo(
            mnemonic: "DIF", parameters: [], comment: "Set difference (TOS-1 AND NOT TOS)"),
        ...
        0x88: OpInfo(
            mnemonic: "CHK", parameters: [], comment: "Check subrange (TOS-1 <= TOS-2 <= TOS"),
        0x89: OpInfo(
            mnemonic: "FLO", parameters: [], comment: "Float next to TOS (int TOS-1 to real TOS)"),
        ...
        0x9D: OpInfo(
            mnemonic: "LDE", parameters: [ParamType.Segment, ParamType.Offset],
            comment: "Load extended word"),
        0x9E: OpInfo(
            mnemonic: "CSP", parameters: [ParamType.Byte], comment: "Call standard procedure"),
        0x9F: OpInfo(mnemonic: "LDCN", parameters: [], comment: "Load constant NIL"),
        0xA0: OpInfo(
            mnemonic: "ADJ", parameters: [ParamType.Byte], comment: "Adjust set to n words"),
        0xA1: OpInfo(
            mnemonic: "FJP", parameters: [ParamType.Address], comment: "Jump if TOS false"),
        0xA2: OpInfo(mnemonic: "INC", parameters: [ParamType.Big], comment: "Inc field ptr"),
        0xA3: OpInfo(
            mnemonic: "IND", parameters: [ParamType.Big], comment: "Static index and load word"),
        ...
        0xA6: OpInfo(
            mnemonic: "LSA", parameters: [ParamType.String], comment: "Load string address"),
        0xA7: OpInfo(
            mnemonic: "LAE", parameters: [ParamType.Byte, ParamType.Big],
            comment: "Load extended address"),
        0xA8: OpInfo(
            mnemonic: "MOV", parameters: [ParamType.Big], comment: "Move words (TOS to TOS-1)"),
        0xA9: OpInfo(mnemonic: "LDO", parameters: [ParamType.Big], comment: "Load global word"),
        0xAA: OpInfo(
            mnemonic: "SAS", parameters: [ParamType.Byte], comment: "String assign (TOS to TOS-1)"),
        0xAB: OpInfo(mnemonic: "SRO", parameters: [ParamType.Big], comment: "Store global word"),
        0xAD: OpInfo(
            mnemonic: "RNP", parameters: [ParamType.Byte], comment: "Return from nonbase procedure"),
        0xAE: OpInfo(
            mnemonic: "CIP", parameters: [ParamType.Byte], comment: "Call intermediate procedure"),
        0xB2: OpInfo(
            mnemonic: "LDA", parameters: [ParamType.Byte, ParamType.Big], comment: "Load addr"),
        0xB6: OpInfo(
            mnemonic: "LOD", parameters: [ParamType.Byte, ParamType.Big], comment: "Load word"),
        0xB8: OpInfo(
            mnemonic: "STR", parameters: [ParamType.Byte, ParamType.Big], comment: "Store TOS"),
        0xB9: OpInfo(
            mnemonic: "UJP", parameters: [ParamType.Address], comment: "Unconditional jump"),
        0xBA: OpInfo(mnemonic: "LDP", parameters: [], comment: "Load packed field (TOS)"),
        0xBB: OpInfo(
            mnemonic: "STP", parameters: [], comment: "Store packed field (TOS into TOS-1)"),
        0xBC: OpInfo(
            mnemonic: "LDM", parameters: [ParamType.Byte], comment: "Load words from (TOS)"),
        0xBD: OpInfo(
            mnemonic: "STM", parameters: [ParamType.Byte], comment: "Store words at TOS to TOS-1"),
        0xBE: OpInfo(mnemonic: "LDB", parameters: [], comment: "Load byte at byte ptr TOS-1 + TOS"),
        0xBF: OpInfo(
            mnemonic: "STB", parameters: [], comment: "Store byte at TOS to byte ptr TOS-2 + TOS-1"),
        0xC0: OpInfo(
            mnemonic: "IXP", parameters: [ParamType.Byte, ParamType.Byte],
            comment: "Index packed array TOS-1[TOS]"),
        0xc1: OpInfo(
            mnemonic: "RBP", parameters: [ParamType.Byte], comment: "Return from base procedure"),
        ...
        0xCC: OpInfo(
            mnemonic: "STL", parameters: [ParamType.Big], comment: "Store TOS into local addr"),
        0xCD: OpInfo(
            mnemonic: "CXP", parameters: [ParamType.Byte, ParamType.Byte],
            comment: "Call external procedure"),
        0xCE: OpInfo(
            mnemonic: "CLP", parameters: [ParamType.Byte], comment: "Call local procedure"),
        0xCF: OpInfo(
            mnemonic: "CGP", parameters: [ParamType.Byte], comment: "Call global procedure"),
        0xD0: OpInfo(
            mnemonic: "LPA", parameters: [ParamType.ByteArray], comment: "Load packed array"),
        0xD1: OpInfo(
            mnemonic: "STE", parameters: [ParamType.Byte, ParamType.Big],
            comment: "Store extended word (TOS into word mem)"),
    ...
    func process(inCode: Data, enterIC: Int, addr: Int) {
        ...
        do {
            while code.ipc < addr && !done {
                ...
                let opcode = try code.readByte()
                var instrDetail = opTable[opcode]
                if instrDetail == nil {
                    if opcode <= 0x7F {
                        instrDetail = OpInfo(
                            mnemonic: "SLDC", parameters: [ParamType.Constant], constant: opcode,
                            comment: "Short load constant")
                    } else if opcode == 0xac {
                        instrDetail = OpInfo(
                            mnemonic: "XJP",
                            parameters: [
                                ParamType.CaseMinimum, ParamType.CaseMaximum, ParamType.Byte,
                                ParamType.Address, ParamType.WordArray,
                            ], comment: "Case jump")
                    } else if opcode == 0xaf {
                        instrDetail = OpInfo(
                            mnemonic: "EQL", parameters: [ParamType.ComparisonDataType],
                            comment: "TOS-1 = TOS")
                    } else if opcode == 0xb0 {
                        instrDetail = OpInfo(
                            mnemonic: "GEQ", parameters: [ParamType.ComparisonDataType],
                            comment: "TOS-1 >= TOS")
                    } else if opcode == 0xb1 {
                        instrDetail = OpInfo(
                            mnemonic: "GRT", parameters: [ParamType.ComparisonDataType],
                            comment: "TOS-1 > TOS")
                    } else if opcode == 0xb3 {
                        instrDetail = OpInfo(
                            mnemonic: "LDC",
                            parameters: [ParamType.DataLength, ParamType.WordArray],
                            comment: "Load multiple-word constant")
                    } else if opcode == 0xb4 {
                        instrDetail = OpInfo(
                            mnemonic: "LEQ", parameters: [ParamType.ComparisonDataType],
                            comment: "TOS-1 <= TOS")
                    } else if opcode == 0xb5 {
                        instrDetail = OpInfo(
                            mnemonic: "LES", parameters: [ParamType.ComparisonDataType],
                            comment: "TOS-1 < TOS")
                    } else if opcode == 0xb7 {
                        instrDetail = OpInfo(
                            mnemonic: "NEQ", parameters: [ParamType.ComparisonDataType],
                            comment: "TOS-1 <> TOS")
                    } else if 0xd8...0xe7 ~= opcode {
                        instrDetail = OpInfo(
                            mnemonic: "SLDL", parameters: [ParamType.Constant],
                            constant: opcode - 0xd7, comment: "Short load local")
                    } else if 0xe8...0xf7 ~= opcode {
                        instrDetail = OpInfo(
                            mnemonic: "SLDO", parameters: [ParamType.Constant],
                            constant: opcode - 0xe7, comment: "Short load global")
                    } else if 0xf8...0xff ~= opcode {
                        instrDetail = OpInfo(
                            mnemonic: "SIND", parameters: [ParamType.Constant],
                            constant: opcode - 0xf8, comment: "Short index load")
                    }
                }
                ...
                for pt in instrDetail?.parameters ?? [] {
                    switch pt {
                    case .Byte:
                        ps = ps.appendingFormat("%d ", try code.readByte())
                    case .Big:
                        ps = ps.appendingFormat("%d ", try code.readBig())
                    case .Word:
                        ps = ps.appendingFormat("%d ", try code.readWord())
                    case .Address:
                        ps = ps.appendingFormat("%04x ", try code.readAddress())
                    case .String:
                        ps = ps.appendingFormat("'%@' ", try code.readString())
                    case .ByteArray:
                        ps = ps.appendingFormat("%@ ", try code.readByteArray())
                    case .WordArray:
                        var len: Int?
                        if let dl = instrDetail?.dataLength {
                            len = Int(dl)
                        } else if let mx = instrDetail?.caseMaximum,
                            let mn = instrDetail?.caseMinimum
                        {
                            len = mx - mn + 1
                        }

                        ps = ps.appendingFormat("%@ ", try code.readWordArray(count: len ?? 0))
                    case .Constant:
                        ps = ps.appendingFormat("%d ", instrDetail?.constant ?? 0)
                    case .DataLength:
                        instrDetail?.dataLength = try code.readByte()
                    case .ComparisonDataType:
                        instrDetail?.comparisonDataType = try code.readByte()
                    case .CaseMinimum:
                        instrDetail?.caseMinimum = Int(try code.readWord())
                    case .CaseMaximum:
                        instrDetail?.caseMaximum = Int(try code.readWord())
                    case .CSPOpCode:
                        instrDetail?.cspOpCode = try code.readByte()
                    case .Segment:
                        instrDetail?.segment = try code.readByte()
                    case .Offset:
                        instrDetail?.offset = try code.readBig()
                    }
                }

                if instrDetail?.mnemonic == "RNP" || instrDetail?.mnemonic == "RBP"
                    || instrDetail?.mnemonic == "XIT"
                {
                    done = true
                }
                ...
                print(
                    String(
                        format: "%04x: %4@ %15@ %@", ic,
                        instrDetail?.mnemonic.padding(toLength: 5, withPad: " ", startingAt: 0)
                            ?? "???",
                        (ps.isEmpty ? "" : ps).padding(toLength: 15, withPad: " ", startingAt: 0),
                        instrDetail?.comment ?? "???"))
                if ps2.isEmpty == false { print(String(format: "            %@", ps2)) }
            }

        } catch {
            print("Error processing code at \(String(format:"%04X",code.ipc)): \(error)")
        }
    }
}
