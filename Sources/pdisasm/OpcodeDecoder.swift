...
struct OpcodeDecoder {
    ...
    struct DecodedInstruction {
        ...
        init(
            opcode: UInt8, mnemonic: String, params: [Int] = [], bytesConsumed: Int, comment: String? = nil,
        ...
        -> DecodedInstruction
    {
        ...
        case ngi:
            return DecodedInstruction(opcode: opcode, mnemonic: "NGI", bytesConsumed: 1, comment: "Negate integer")
        case ngr:
            return DecodedInstruction(opcode: opcode, mnemonic: "NGR", bytesConsumed: 1, comment: "Negate real")
        case lnot:
            return DecodedInstruction(opcode: opcode, 
        ...
        case nop:
            return DecodedInstruction(opcode: opcode, mnemonic: "NOP", bytesConsumed: 1, comment: "No operation")
        case bpt:
            let (val, inc) = try cd.readBig(at: ic + 1)
            return DecodedInstruction(opcode: opcode, 
