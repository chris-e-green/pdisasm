...
@available(
    *,
    deprecated,
    message:
        "Use CodeData.readXXX(...) throwing helpers instead for safe, bounds-checked reads"
)
extension Data {
    ...
    @available(
        *,
        deprecated,
        message: "Use CodeData to read code blocks and bytes safely"
    )
    ...
    @available(
        *,
        deprecated,
        message: "Use CodeData.readBig(at:) for bounds-checked, throwing reads"
    )
    ...
    @available(
        *,
        deprecated,
        message: "Use CodeData.readWord(at:) for bounds-checked, throwing reads"
    )
    ...
    @available(
        *,
        deprecated,
        message:
            "Use CodeData.getSelfRefPointer(at:) for bounds-checked pointer resolution"
    )
