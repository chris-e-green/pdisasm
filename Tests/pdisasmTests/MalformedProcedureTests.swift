...
final class MalformedProcedureTests: XCTestCase {
    func testDecodeSkipsMalformedProcedureHeader() throws {
        ...
        decodePascalProcedure(currSeg: Segment(codeaddr: 0, codeleng: smallCode.count, name: "TST", segkind: .dataseg, textaddr: 0, segNum: 0, mType: 0, version: 0), procedureNumber: 1, proc: &proc, code: smallCode, addr: 2, callers: &callers, allLocations: &allLocations, allProcedures: &allProcedures)
